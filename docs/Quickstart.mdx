...
`curl -L https://github.com/enarx/enarx/releases/download/v0.6.4/enarx-universal-darwin --output enarx`
...
`wget https://github.com/enarx/enarx/releases/download/v0.6.4/enarx-x86_64-unknown-linux-musl`
...
```sh
wget https://github.com/enarx/enarx/releases/download/v0.6.4/enarx-x86_64-unknown-linux-musl.sig
