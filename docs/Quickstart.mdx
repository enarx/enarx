...
`curl -L https://github.com/enarx/enarx/releases/download/v0.6.3/enarx-universal-darwin --output enarx`
...
`wget https://github.com/enarx/enarx/releases/download/v0.6.3/enarx-x86_64-unknown-linux-musl`
