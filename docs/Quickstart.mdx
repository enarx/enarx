...
`curl -L https://github.com/enarx/enarx/releases/download/v0.7.0/enarx-universal-darwin --output enarx`
...
```sh
sudo yum install -y --nogpgcheck https://github.com/enarx/enarx/releases/download/v0.7.0/enarx-0.7.0-1.x86_64.rpm
```
...
```sh
wget https://github.com/enarx/enarx/releases/download/v0.7.0/enarx-0.7.0-1_amd64.deb
sudo dpkg -i enarx-0.7.0-1_amd64.deb
```
...
`wget https://github.com/enarx/enarx/releases/download/v0.7.0/enarx-x86_64-unknown-linux-musl`
...
```sh
wget https://github.com/enarx/enarx/releases/download/v0.7.0/enarx-x86_64-unknown-linux-musl.sig
