...
#[serial]
fn exit_zero() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_exit_zero");
...
#[serial]
fn exit_one() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_exit_one");
...
fn clock_gettime() {
    ...
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_clock_gettime");
...
#[serial]
fn close() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_close");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn write_stdout() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_write_stdout");
...
#[serial]
fn write_stderr() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_write_stderr");
...
#[serial]
fn write_emsgsize() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_write_emsgsize");
    run_test(bin, 0, None, None, None);
}
...
fn read() {
    ...
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_read");
...
fn readv() {
    ...
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_readv");
    run_test(bin, 0, INPUT.as_slice(), INPUT.as_slice(), None);
}
...
#[serial]
fn uname() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_uname");
    run_test(bin, 0, None, None, None);
}
...
fn read_udp() {
    ...
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_read_udp");
...
#[serial]
fn get_att() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_get_att");
    run_test(bin, 0, None, None, None);
}
...
fn sgx_get_att_quote() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_sgx_get_att_quote");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn getuid() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_getuid");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn geteuid() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_geteuid");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn getgid() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_getgid");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn getegid() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_getegid");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn socket() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_socket");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn bind() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_bind");
    run_test(bin, 0, None, None, None);
}
...
#[serial]
fn listen() {
    let bin = env!("CARGO_BIN_FILE_RUST_SYSCALL_TESTS_listen");
    run_test(bin, 0, None, None, None);
}
