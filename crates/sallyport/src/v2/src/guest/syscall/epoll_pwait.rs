...
use crate::guest::alloc::{Allocator, Collector, Commit, Committer, Input, Output, Syscall};
use crate::Result;
...
unsafe impl<'a> Syscall<'a> for EpollPwait<'a> {
    const NUM: c_long = libc::SYS_epoll_pwait;
