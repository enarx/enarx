...
use crate::thread::{pickup_new_threads, GenPurposeRegs, TcbRefCell};
...
impl From<*const SyscallStackFrameValue> for GenPurposeRegs {
    fn from(v: *const SyscallStackFrameValue) -> Self {
        let v = unsafe { &*v };
        GenPurposeRegs {
            rax: v.rax,
            rdx: v.rdx,
